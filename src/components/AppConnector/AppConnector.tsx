    ...
    <div className="flex flex-col h-full bg-white text-black">
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="p-6 pb-4 pt-12">
          <h1 className="text-2xl font-bold mb-2 text-black">Data Connectors & MCPs</h1>
        ...
        <div className="px-6 mb-6">
          <h2 className="text-xl font-semibold mb-6 text-black">Add connectors</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filteredConnectors.map((connector) => (
              <div
                key={connector.id}
                className="bg-orange-50 border border-orange-200 rounded-2xl p-6 hover:bg-orange-100 transition-all duration-200 cursor-pointer group hover:border-orange-300 h-24 flex items-center"
              >
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center space-x-4">
                    <div className="flex-shrink-0 p-3 bg-white rounded-xl border border-orange-200">
                      {renderConnectorIcon(connector)}
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-semibold text-black group-hover:text-orange-600 transition-colors mb-1">
                        {connector.name}
                      </h3>
        ...
        <div className="px-6 pb-6">
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-6 flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-black">Need another connection?</h3>
                <p className="text-sm text-gray-600">Let us know what data you'd like to use in Afterwon</p>
              </div>
            </div>
