    ...
    >
      <div className="bg-white rounded-2xl p-12 max-w-lg w-full mx-4 relative">
        ...
        <div className="text-center mb-10">
          <h2 className="text-4xl font-normal text-orange-500 mb-4" style={{fontFamily: 'SpectralLight, serif'}}>
        ...
        <div className="space-y-4 mb-8">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-orange-500 text-white py-4 px-6 font-medium hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
