    ...
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
      ...
      {hasMoreRows && (
        <div className="bg-white px-6 py-4 border-b border-orange-100 flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium bg-orange-50 text-orange-700 rounded-lg hover:bg-orange-100 transition-colors border border-orange-200"
          >
          ...
          <table className="w-full">
            <thead className="sticky top-0">
              <tr className="bg-orange-50 border-b border-orange-200">
                <th className="px-4 py-3 text-center font-semibold text-orange-800 bg-orange-50 sticky top-0 left-0 z-40 border-r border-orange-200 text-xs uppercase tracking-wider w-16">
                  #
                </th>
                {visibleColumns.map((column, index) => (
                  <th
                    key={index}
                    className="px-4 py-3 text-center font-semibold text-orange-800 border-r border-orange-100 text-xs uppercase tracking-wider relative group sticky top-0 bg-orange-50"
                    style={{
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {visibleRows.map((row, rowIndex) => (
                ...
                >
                  <td className="px-4 py-3 font-medium text-orange-600 bg-orange-50 sticky left-0 z-10 border-r border-orange-100 text-sm w-16 text-center">
                    {rowIndex + 1}
                  </td>
      ...
      <div className="bg-orange-50 px-6 py-4 border-t border-orange-100">
        <div className="flex items-center justify-between">
          ...
          <div className="text-xs text-orange-700 bg-white px-3 py-1 rounded-full border border-orange-200">
            Ready
          </div>
        </div>
      </div>
