  ...
  return (
    <div className="flex flex-col h-full bg-white text-black">
      <div className="max-w-6xl mx-auto w-full">
        {/* Header */}
        <div className="flex-shrink-0 px-8 py-6 pt-12 border-b border-gray-200">
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-2xl font-bold text-black">{t('projects.title')}</h1>
            <button
              onClick={handleOpenModal}
              className="flex items-center gap-2 px-5 py-2.5 bg-orange-500 text-white rounded-xl hover:bg-orange-600 transition-all duration-200 shadow-sm font-medium"
            >
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="block w-full pl-12 pr-4 py-3 bg-orange-50 border border-orange-200 rounded-xl leading-5 text-black placeholder-gray-400 focus:outline-none focus:bg-orange-100 focus:border-orange-400 focus:ring-2 focus:ring-orange-200 transition-all duration-200"
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 bg-orange-50 border border-orange-200 rounded-lg hover:bg-orange-100 transition-all duration-200"
              >
                {t('projects.sortBy')}
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-44 bg-white border border-gray-200 rounded-xl shadow-xl z-10 overflow-hidden">
                  {getSortOptions(t).map((option) => (
                    <button
                      ...
                      className={`block w-full text-left px-4 py-3 text-sm hover:bg-orange-50 transition-colors duration-150 ${
                        sortBy === option.value ? 'bg-orange-100 text-black' : 'text-gray-700'
                      }`}
                    >
                      {option.label}
                    </button>
        ...
        <div className="flex-1 overflow-y-auto p-8">
          {loadingProjects ? (
            <div className="flex items-center justify-center py-20">
              <div className="text-gray-500">{t('projects.loadingProjects')}</div>
            </div>
          ) : (
            <>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {filteredProjects.map((project) => (
                  <div
                    ...
                    className="bg-orange-50 border border-orange-200 rounded-2xl p-6 hover:bg-orange-100 hover:border-orange-300 transition-all duration-300 cursor-pointer group flex flex-col h-72"
                  >
                    {/* Project Header */}
                    ...
                    <h3
                      className="text-lg font-semibold text-black mb-3 group-hover:text-gray-900 transition-colors duration-200"
                      style={{
                        display: '-webkit-box',
                        WebkitLineClamp: 1,
                    ...
                    <div className="text-sm text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-200 flex-1 overflow-hidden">
                      <p
                        style={{
                          display: '-webkit-box',
                          WebkitLineClamp: 3,
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-500 group-hover:text-gray-600 transition-colors duration-200 pt-2 mt-2 border-t border-orange-200">
