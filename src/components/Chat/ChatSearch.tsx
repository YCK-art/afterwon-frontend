      ...
      <div className="px-6 mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-orange-50 border border-orange-200 rounded-lg pl-12 pr-4 py-2 text-black placeholder-gray-400 focus:outline-none focus:border-orange-400 focus:bg-orange-100"
          />
        </div>
      </div>
          ...
          <div className="space-y-1">
            {filteredHistory.map((session) => (
              <button
                ...
                className="w-full text-left p-4 hover:bg-orange-50 rounded-lg transition-colors border-b border-gray-200 last:border-b-0"
              >
                <div className="mb-2">
