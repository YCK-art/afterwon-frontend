  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        <div className="relative flex items-center bg-white border border-gray-300 rounded-2xl shadow-md hover:shadow-lg focus-within:border-orange-400 focus-within:ring-1 focus-within:ring-orange-400 transition-all min-h-[48px]">
          {/* Plus Button */}
          {onFileUpload && (
            <button
