    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            AI for <span className="italic">Product Teams</span>
          </h1>
          ...
          >
            Empower your product decisions with data. Analyze user behavior,
            track metrics, and identify growth opportunities with AI insights.
          </p>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            >
              User Analytics in Real-Time
            </h2>
            <p
              className="text-lg text-black max-w-3xl mx-auto"
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Connect your product analytics tools and track user engagement, retention,
              and feature adoption with instant insights and automated reporting.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Make informed decisions with AI-powered insights. Analyze A/B tests,
              predict feature impact, and prioritize your roadmap based on data.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Share insights across your team instantly. Generate reports, dashboards,
              and presentations that keep everyone aligned on product goals.
            </p>
          </div>
