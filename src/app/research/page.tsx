    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            AI for <span className="italic">Research Analysis</span>
          </h1>
          ...
          >
            Accelerate your research with AI-powered data analysis. Process large
            datasets, identify patterns, and generate insights for your studies.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Run complex statistical tests, perform regression analysis, and validate
              hypotheses with AI assistance. Get publication-ready results instantly.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Synthesize research findings, identify trends across studies, and
              organize references efficiently with AI-powered literature analysis.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Create publication-quality charts, graphs, and figures automatically.
              Export in multiple formats ready for journals and presentations.
            </p>
          </div>
