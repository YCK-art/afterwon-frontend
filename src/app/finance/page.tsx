    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            AI for <span className="italic">Financial Decision</span>
          </h1>
          ...
          >
            Connect your financial data sources and get instant insights,
            forecasts, and reports. Ready when you start your day.
          </p>
      ...
      {/* Second Section - Ditch the spreadsheet struggle */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Skip the manual exports. Afterwon connects to your databases and
              files so you can run analyses and build reports in seconds.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Description text for the third section goes here.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Description text for the fourth section goes here.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Description text for the fifth section goes here.
            </p>
          </div>
