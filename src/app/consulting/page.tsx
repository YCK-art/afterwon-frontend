    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            AI for <span className="italic">Consulting Excellence</span>
          </h1>
          ...
          >
            Deliver data-driven insights to your clients faster. Analyze complex
            datasets, create compelling visualizations, and generate reports in minutes.
          </p>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            >
              Client-Ready Analysis in Minutes
            </h2>
            <p
              className="text-lg text-black max-w-3xl mx-auto"
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Upload client data and get instant, presentation-ready insights.
              Generate professional reports, charts, and recommendations automatically.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Handle more projects without sacrificing quality. AI assists with data
              preparation, analysis, and report generation so you focus on strategy.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "Arial, sans-serif" }}
            >
              Maintain high standards across all projects. Create branded reports,
              standardized analyses, and polished presentations every time.
            </p>
          </div>
